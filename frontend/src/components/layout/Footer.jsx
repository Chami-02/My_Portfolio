  ...
  return (
    ...
    >
      ...
      >
        {/* Left: Branding */}
        <div>
          <p style={{ fontFamily: 'var(--font-mono)', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '0.25rem' }}>
          ...
          <p style={{ fontFamily: 'var(--font-mono)', fontSize: '0.75rem', color: 'var(--text-muted)' }}>
            © {year} Parindra Chameekara
          </p>
        </div>

        {/* Center: Built with */}
        <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)', textAlign: 'center' }}>
